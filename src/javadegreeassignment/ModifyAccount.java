...
public class ModifyAccount extends javax.swing.JFrame {
    ...
    People PremodifiedAccData;
    
    public ModifyAccount(People Info) {
    
        initComponents();
        
        PremodifiedAccData = Info;
        
        TxtAccName.setText(Info.GetName());
        TxtEmail.setText(Info.GetEmail());
        TxtIC.setText(Info.GetIC());
        TxtContactNumber.setText(Info.GetContactNumber());
        TxtUsername.setText(Info.GetUsername());
        TxtPassword.setText(Info.GetPassword());
        
        if ("true".equals(String.valueOf((Info.GetCitizen())))){
            
            RdBtnCitizen.setSelected(true);
            RdBtnNotCitizen.setSelected(false);
            
        }else if ("false".equals(String.valueOf((Info.GetCitizen())))){
    ...
    private void initComponents() {
        ...
        jPanel7.add(BtnModify, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 690, 150, -1));
        ...
        LblPgeTtle3.setText("Modify Account");
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel7, javax.swing.GroupLayout.DEFAULT_SIZE, 765, Short.MAX_VALUE)
        );
    ...
    private void BtnModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnModifyActionPerformed
        ...
        String PreFileName = PremodifiedAccData.GetName() + "_" + PremodifiedAccData.GetIC() + ".txt";
